...
-- CreateEnum
CREATE TYPE "public"."ApplicationStatus" AS ENUM ('SUBMITTED', 'IN_REVIEW', 'SHORTLISTED', 'INTERVIEW_SCHEDULED', 'INTERVIEWED', 'OFFER_EXTENDED', 'HIRED', 'REJECTED', 'WITHDRAWN');
...
INSERT INTO public.users (username, email, password_hash, first_name, last_name, role, updated_at) 
VALUES ('admin', 'admin@example.com', 'admin', 'Admin', 'Admin', 'ADMIN', CURRENT_TIMESTAMP);
