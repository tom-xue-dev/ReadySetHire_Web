...
// Get all jobs for interviewers (with full details)
router.get('/jobs/tracking', authenticateToken, requireRole(['INTERVIEWER', 'ADMIN']), jobController.getAll.bind(jobController));
