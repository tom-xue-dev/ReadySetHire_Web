 ...
 */
router.get('/employees/:employeeId/saved-jobs', auth_1.authenticateToken, async (req, res) => {
    try {
 ...
 */
router.put('/employees/:employeeId/saved-jobs/:jobId', auth_1.authenticateToken, async (req, res) => {
    try {
        const employeeId = parseInt(req.params.employeeId);
 ...
 */
router.delete('/employees/:employeeId/saved-jobs/:jobId', auth_1.authenticateToken, async (req, res) => {
    try {
        const employeeId = parseInt(req.params.employeeId);
        const jobId = parseInt(req.params.jobId);
        const userId = req.user?.id;
